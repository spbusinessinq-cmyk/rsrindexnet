              ...
              <EmptyState
                ...
                subtitle={
                  sourcesActive > 0
                    ...
                    : "Records appear here when signals have been classified, structured, and committed to the index. The commit pipeline is ready — no records have been committed yet."
                }
                statusLine={hasStaged
                  ? `Index ready — ${totalStaged} staged candidate${totalStaged !== 1 ? "s" : ""} awaiting classification`
                  : "Index layer ready — 0 committed records"}
              />

              {/* Staged candidates notice */}
              {hasStaged && (
                <div className="rounded p-5 max-w-lg w-full"
                  style={{ border: "1px solid rgba(34,197,94,0.16)", background: "rgba(6,14,9,0.5)" }}>
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="font-orbitron font-bold tracking-wider"
                      style={{ color: "rgba(34,197,94,0.75)", fontSize: "10px" }}>
                  ...
                  <p className="font-mono-tactical leading-relaxed"
                    ...
                    Staged candidates require classification and operator review before a commit is allowed.
                  </p>
                  <div className="mt-3 pt-3 flex items-center gap-2"
                    ...
                    <span className="font-mono-tactical italic"
                      style={{ color: "rgba(155,175,170,0.5)", fontSize: "9.5px" }}>
                      Staged items are not shown publicly. Classification and commit controls are in the operator layer.
                    </span>
                  </div>
                </div>
              )}

              {/* Cross-link to signals and datasets */}
              <div className="max-w-lg w-full flex gap-3">
                <button onClick={() => setLocation("/signals")}
                  ...
                  <div className="font-orbitron font-bold tracking-wider"
                    style={{ color: "rgba(34,197,94,0.58)", fontSize: "9.5px" }}>
                    SIGNALS ←
                  </div>
                  <div className="font-mono-tactical mt-1"
                    style={{ color: "rgba(155,175,170,0.48)", fontSize: "9px" }}>
                    Signal intake layer
                  </div>
                </button>
          ...
          <div className="shrink-0 flex flex-col overflow-hidden hidden lg:flex"
                ...
                {RECORD_FIELDS.map((field) => (
                  <div key={field.key} className="flex items-center gap-2">
                    ...
                    <span className="font-mono-tactical flex-1"
                      style={{ color: field.required ? "rgba(185,205,200,0.72)" : "rgba(155,175,170,0.45)", fontSize: "9.5px" }}>
                      {field.key}
                    </span>
            ...
            <div className="px-5 py-4 space-y-3 flex-1 overflow-y-auto">
                ...
                {[
                  ...
                  <div key={item.label} className="flex items-baseline justify-between">
                    <span className="font-mono-tactical"
                      style={{ color: "rgba(155,175,170,0.48)", fontSize: "9px", letterSpacing: "0.08em" }}>
                      {item.label}
                    </span>
                    <span className="font-mono-tactical"
                      style={{
                        color: item.active ? "rgba(34,197,94,0.72)" : "rgba(185,205,200,0.62)",
                        fontSize: "11px",
                      }}>
                      {item.value}
                    </span>
              ...
              <div>
                ...
                <div className="space-y-1 font-mono-tactical"
                  style={{ fontSize: "9px", color: "rgba(155,175,170,0.42)", lineHeight: "1.8" }}>
                  <div>SIGNALS → intake</div>
                  <div>DATASETS → structure</div>
                  <div style={{ color: "rgba(34,197,94,0.55)" }}>INDEX ← this layer</div>
                </div>
              </div>
            </div>
          </div>
