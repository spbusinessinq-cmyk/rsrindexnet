    ...
    <AppShell>
      <div className="flex flex-col" style={{ minHeight: "calc(100vh - 84px)" }}>
        <PageHeader
          ...
          title="OVERVIEW"
          subtitle="What INDEX is, what it does, and how the signal-to-structure pipeline works"
        />

        <div className="flex-1 p-6 md:p-8 space-y-8 max-w-4xl">
          {/* What / What not */}
            ...
            <div className="rounded p-5 space-y-3 idx-card"
              ...
              <div className="space-y-2">
                {[
                  ...
                  "Not a duplicate of the RSR Intel site",
          ...
          <div>
            <div className="font-mono-tactical tracking-widest uppercase mb-5"
              style={{ color: "rgba(34,197,94,0.32)", fontSize: "9.5px", letterSpacing: "0.2em" }}>
              The Pipeline
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
              {SECTORS.map((sector) => (
                <button key={sector.label} onClick={() => setLocation(sector.path)}
                  ...
                  <div className="font-orbitron text-xs font-bold tracking-wider mb-1.5" style={{ color: "rgba(34,197,94,0.7)" }}>
                    {sector.label}
                  </div>
                  <div className="font-mono-tactical" style={{ color: "rgba(255,255,255,0.28)", fontSize: "10px", lineHeight: "1.7" }}>
                    {sector.description}
                  </div>
                </button>
              ))}
